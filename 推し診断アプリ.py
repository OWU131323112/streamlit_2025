...
characters = {
    "須王芦佳": {
        "image": os.path.join("S:/webプログラミング/", "須王.PNG"),
        "bio": "愛され無能のトラブルメーカー！"
    },
    "樋宮明星": {
        "image": os.path.join("S:/webプログラミング/", "樋宮.PNG"),
        "bio": "甘え上手な底なし沼"
    },
    "槻本大河": {
        "image": os.path.join("S:/webプログラミング/", "槻本.PNG"),
        "bio": "出自を疎む経理兼オカン"
    },
    "相沢篠信": {
        "image": os.path.join("S:/webプログラミング/", "相沢.PNG"),
        "bio": "愛嬌たっぷりの利口な狂犬"
    },
    "祠堂恭耶": {
        "image": os.path.join("S:/webプログラミング/", "祠堂.PNG"),
        "bio": "気品と自信溢れる美術講師"
    },
    "神家": {
        "image": os.path.join("S:/webプログラミング/", "神家.PNG"),
        "bio": "記憶喪失のバレリーノ"
    }
}
